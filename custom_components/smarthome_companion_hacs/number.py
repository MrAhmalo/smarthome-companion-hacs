        ...
        for entity_id, config in blinds.items():
            ...
            if entity_id not in added_blind_entities:
                new_entities.extend([
                    ...
                    _BlindBaseGenericNumber(hass, store, blinds_manager, entity_id, "shading_temp_threshold", "Beschattung Temperatur-Schwellwert", "smarthome_companion_number_shading_temp_threshold", "mdi:thermometer", 15.0, 40.0, 0.5, "°C", 24.0),
                    _BlindBaseGenericNumber(hass, store, blinds_manager, entity_id, "shading_intensity_threshold", "Beschattung Helligkeit-Schwellwert", "smarthome_companion_number_shading_intensity_threshold", "mdi:white-balance-sunny", 0, 1000, 10, "W/m²", 600),
                    _BlindBaseGenericNumber(hass, store, blinds_manager, entity_id, "shading_azimuth_min", "Beschattung Azimut Min", "smarthome_companion_number_shading_azimuth_min", "mdi:compass-outline", 0, 360, 1, "°", 0),
                    _BlindBaseGenericNumber(hass, store, blinds_manager, entity_id, "shading_azimuth_max", "Beschattung Azimut Max", "smarthome_companion_number_shading_azimuth_max", "mdi:compass-outline", 0, 360, 1, "°", 360),
                    _BlindBaseGenericNumber(hass, store, blinds_manager, entity_id, "shading_elevation_min", "Beschattung Elevation Min", "smarthome_companion_number_shading_elevation_min", "mdi:angle-acute", -90, 90, 1, "°", 0),
